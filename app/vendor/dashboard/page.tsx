...
import ProductData from "@/components/vendor/dashboard/product.performance";
...
import OutOfStockProducts from "@/components/vendor/dashboard/out-of-stock-products";
  ...
  const VendorDashboardPage = async() => {
    ...
    return (<div className="container items-center justify-center">
      ...
      <div className="my-[20px]">
        <div className="">
          <div className="SecondaryTitleStyle">
            Recent Orders
          </div>
        </div>
